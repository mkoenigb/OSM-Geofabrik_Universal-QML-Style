  ...
  <renderer-v2 symbollevels="0" forceraster="0" type="RuleRenderer" enableorderby="0">
    <rules key="{6e91973e-b243-4f4b-a424-2e1e171306d4}">
      <rule label="0 - 25000" scalemindenom="1" scalemaxdenom="25001" key="{33d39f50-3b22-44f8-9aac-42d0ae4bcb58}">
        <rule label="bus station" filter="&quot;fclass&quot; = 'bus_station'" key="{0bc96d74-9ddf-4a5f-8b96-88b0d68ddf5b}" symbol="0"/>
        <rule label="railway station" filter="&quot;fclass&quot; = 'railway_station'" key="{14fb4a5c-9cb7-4a9c-ae43-427dc7fc90da}" symbol="1"/>
      </rule>
    </rules>
    <symbols>
      <symbol alpha="1" type="fill" name="0" clip_to_extent="1">
        <layer class="SimpleFill" enabled="1" pass="0" locked="0">
          ...
          <prop v="175,156,141,255" k="color"/>
